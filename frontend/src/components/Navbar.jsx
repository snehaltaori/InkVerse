...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-md shadow text-white px-6 py-3 flex justify-between items-center">
            ...
            <Link
                to="/"
                className="text-2xl font-cursive text-mutedGreen"
            >
                InkVerse
            </Link>
            ...
            <form
                ...
                className="flex items-center gap-2 bg-white/10 px-3 py-1 rounded-full w-1/2"
            >
            ...
            <div className="flex items-center gap-4 relative" ref={dropdownRef}>
                {!user ? (
                    ...
                    <>
                        ...
                        {isDropdownOpen && (
                            <div className="absolute right-0 top-12 bg-white/10 backdrop-blur-lg rounded-md p-2 shadow-lg text-sm w-48 z-50">
                                    <Link
                                        to="/profile"
